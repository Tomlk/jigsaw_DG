...
def get_args():
    ...
    parser.add_argument("--train_all", type=bool, default=False, help="If true, all network weights will be trained")
    parser.add_argument("--suffix", default="", help="Suffix for the logger")
    parser.add_argument("--nesterov", type=bool, default=False, help="Use nesterov")
    parser.add_argument("--TTA", type=bool, default=False, help="Use nesterov")
    parser.add_argument("--gpu", type=int, default=0, help="Use nesterov")
